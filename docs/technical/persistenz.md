...
Lineare Kette: `001_unified` → `002_installation_project_attrs` → `003_temporal_lm_bus`.

`003` ist Migration (DDL-History). Leser-Doku verwendet `last_modified` / `last_import`, nicht die alten Spaltennamen als Ist.
