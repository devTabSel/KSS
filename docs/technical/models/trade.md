...
Kein 3API-Resource-Typ. Kategorie 3 aus knxproj `Trade_t`. Nicht im TTL (nur `mac:assignedTrade` als Name, nicht eindeutig). `tag:lighting` ist kein Gewerk. HTTP noch nicht verdrahtet.
