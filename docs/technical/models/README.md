...
| --- | --- | --- |
| Installation | [installation.md](installation.md) | GET v1+kss (`/api/kss/{t}/`, Datei-Export); PATCH `.knxproj` / `.ttl` |
| Location (+ Function) | [location.md](location.md) | GET v1+kss |
| Topology | [topology.md](topology.md) | GET kss (areas/lines/segments) |
| Device | [device.md](device.md) | GET v1+kss; `orderNumber`/`manufacturer` Join `MasterProduct`; `kss:hardwareProgramRef` nur kss |
